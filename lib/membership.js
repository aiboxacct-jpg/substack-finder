...
// Is this token the site owner? Returns the user if their email matches
// ADMIN_EMAIL, otherwise null. Same gate the /api/admin/* routes apply inline;
// extracted here so new routes stop copying it.
